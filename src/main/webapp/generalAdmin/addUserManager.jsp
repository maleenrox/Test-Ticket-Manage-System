...
<head>
    <meta charset="UTF-8">
    <title>Add User Manager - GJ Fox</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="form-container">
    ...
    <form action="../AddUserManager" method="POST">
        <input type="text" name="userManagerID" placeholder="User Manager ID" required />
        <input type="text" name="userManagerName" placeholder="User Manager Name" required />
        <input type="email" name="email" placeholder="Email" required />
        <input type="tel" name="phoneNumber" placeholder="Phone Number" required />
        <input type="password" name="password" placeholder="Password" required />
        <button type="submit">Add User Manager</button>
    </form>
    <p>Back to <a href="userManagerSettings.jsp">User Manager Settings Dashboard</a></p>
</div>
<script>
    setTimeout(function () {
