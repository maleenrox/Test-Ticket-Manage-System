...
<head>
    <meta charset="UTF-8">
    <title>Add Event Manager - GJ Fox</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="form-container">
    ...
    <p>Back to <a href="addEventManager.jsp">Event Manager Settings Dashboard</a></p>
</div>
<script>
    setTimeout(function () {
