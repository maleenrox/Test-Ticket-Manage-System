...
<div class="container">
    ...
    <div class="description">
        <p>Manage and monitor all event managers in the event ticketing system. You can add new event managers, remove event managers, and view their details and activity in this section.</p>
    </div>
    <%
    ...
    <div class="user-info">
        ...
        <ul>
            <li>User Manager Count: <strong> <%= eventManagerCount %></strong></li>
        </ul>
    </div>

    <!-- Buttons to Add/Remove Users -->
    <div class="buttons">
        <button onclick="window.location.href='addEventManager.jsp'">Add Event Manager</button>
        <button onclick="window.location.href='removeEventManager.jsp'">Remove Event Manager</button>
    </div>
    ...
    <div class="table-container">
        <table>
            ...
            <%
                ...
                File file = new File(eventManagerDBPath);
