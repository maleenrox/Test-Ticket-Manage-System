...
<head>
    <meta charset="UTF-8">
    <title>Remove Event - GJ Fox</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="form-container">
    <h2>Remove Event</h2>
    <form action="../RemoveEvent" method="POST" onsubmit="return confirmRemoval()">
        <input type="text" name="eventName" placeholder="Enter Event Name" required />
        <button type="submit">Remove Event</button>
    </form>
    <p class="warning">Warning: Make sure you have entered the correct event name. This action is irreversible.</p>
    <p class="normal-text">Back to <a href="eventManagerDashboard.jsp">Event Manager Dashboard</a></p>
</div>

<script>
    function confirmRemoval() {
        const eventName = document.querySelector('input[name="eventName"]').value;
        const confirmAction = confirm(`Are you sure you want to remove the event: ${eventName}? This action cannot be undone.`);
