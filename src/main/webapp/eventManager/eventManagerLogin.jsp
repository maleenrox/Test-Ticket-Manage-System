...
<head>
    <meta charset="UTF-8">
    <title>Event Manager Login - GJ Fox</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .form-container {
            ...
            color: #fff;
            width: 350px;
            box-shadow: 0 0 30px rgba(255, 28, 96, 0.8);
...
<div class="form-container">
    ...
    <form action="../EventManagerLoginServlet" method="POST">
        <input type="text" name="userName" placeholder="Event Manager ID" required />
