    ...
    <style>
        * {
        ...
        body {
            ...
            /*background: url('C:/data/Test-Ticket-Manage-System/src/main/resources/images/a(8).jpg') no-repeat center center fixed;*/
...
<div class="form-container">
    ...
    <p><a href="userPassWordChange.jsp">Forgot Password?</a></p>

    <!-- Divider Line -->
    <div class="divider"></div>

    <div class="admin-login">
        <p><a href="loginSelection.jsp">Admin & Managers Login</a></p>
    </div>
</div>
