...
<head>
  ...
  <title>User Management - Event Ticket System</title>
  <style>
...
<div class="container">
  ...
  <div class="description">
    <p>Manage and monitor all users involved in the event ticketing system. You can add new users, remove users, and view their ticket information and activity in this section.</p>
  </div>
  <%
  ...
  <div class="user-info">
    ...
    <ul>
      <li>User Count: <strong> <%= userCount %></strong></li>
    </ul>
  </div>
  ...
  <div class="buttons">
    ...
    <button onclick="window.location.href='removeUser.jsp'">Remove User</button>
  </div>
