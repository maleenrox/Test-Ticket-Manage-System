...
<head>
    <meta charset="UTF-8">
    <title>Remove User - GJ Fox</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="form-container">
    <h2>Remove User</h2>
    <form action="../RemoveUser" method="POST" onsubmit="return confirmRemoval()">
        <input type="text" name="userName" placeholder="Enter User Name" required />
        <button type="submit">Remove User</button>
    </form>
    <p class="warning">Warning: Make sure you have entered the correct username. This action is irreversible.</p>
    <p class="normal-text">Back to <a href="userManagerDashboard.jsp">User Manager Dashboard</a></p>
</div>

<script>
    function confirmRemoval() {
        const userName = document.querySelector('input[name="userName"]').value;
        const confirmAction = confirm(`Are you sure you want to remove the user: ${userName}? This action cannot be undone.`);
