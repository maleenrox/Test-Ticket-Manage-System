...
<div class="form-container">
  ...
  <form action="../AddUser" method="POST">
    ...
    <input type="tel" name="phoneNumber" placeholder="User Phone Number" required />
    <button type="submit">Add User</button>
  </form>
  <p>Go back to <a href="userManagerDashboard.jsp">User Manager Dashboard</a></p>
</div>
<script>
  setTimeout(function () {
